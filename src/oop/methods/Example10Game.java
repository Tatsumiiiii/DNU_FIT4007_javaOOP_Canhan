...
public class Example10Game {
    ...
    public Example09Player getWinner() {
        boolean p1Win = player1.isWinner();
        boolean p2Win = player2.isWinner();
    ...
    public String toString() {
        return "Example10Game{id=" + id + ", player1=" + player1 + ", player2=" + player2 + "}";
    }
}
